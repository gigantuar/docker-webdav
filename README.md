...
This is based on [https://github.com/BytemarkHosting/docker-webdav](https://github.com/BytemarkHosting/docker-webdav), cloned for personal tweaking.
...
docker run --restart always -v /srv/dav:/var/lib/dav \
    ...
    --publish 80:80 -d gigantuar/webdav
...
docker run --restart always -v /srv/dav:/var/lib/dav \
    ...
    -e SSL_CERT=selfsigned --publish 443:443 -d gigantuar/webdav
